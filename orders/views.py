...
def place_order(req, total=0, quantity=0,):
    ...
    if req.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.instance.ip = req.META.get('REMOTE_ADDR')
            ...
            return redirect(sslcommerz_payment_gateway(req, order_number, str(current_user.id), grand_total, form.instance.email))
    else:
